...
public class TwocheckoutOption extends TwocheckoutApi {
    ...
    public static ProductOption retrieve(String option_id) throws TwocheckoutException {
    ...
    public static ProductOptionList list(HashMap<String, String> args) throws TwocheckoutException {
